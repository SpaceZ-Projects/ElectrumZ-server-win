...
from electrumz.lib.hash import sha256, double_sha256, hash_to_hex_str
from electrumz.lib.script import OpCodes
...
class DeserializerLitecoin(DeserializerSegWit):
    ...
    interest to electrumz, and they vanish into the MWEB when mined.
    '''
    def _read_tx_parts(self):
        '''Return a (deserialized TX, tx_hash, vsize) tuple.'''
        start = self.cursor
