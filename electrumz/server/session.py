...
class SessionManager:
    ...
    def __init__(
        ...
        self._sslc = None
        # Event triggered when electrumz is listening for incoming requests.
    ...
    async def rpc_add_peer(self, real_name):
        ...
        real_name: "bch.electrumz.cash t50001 s50002" for example
        '''
...
class SessionBase(RPCSession):
    '''Base class of ElectrumZ JSON sessions.
    ...
    async def handle_request(self, request):
        '''Handle an incoming request.  ElectrumZ doesn't receive
